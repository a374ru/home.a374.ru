...
[Инструкция генератора](assets/Briggs_and_Stratton.pdf)


Мощность генератора составляет 7.5 Киловатт. 

<span style="color: #e34234;">Генератор размещен в боксе, при его работе требуется открыть крышку бокса в районе выхлопной трубы и оставить дверь бокса открытой полностью.</span> 
...
После запуска генератора можно переключить реверсивный переключатель в доме на электро ящике в режим генератора.

На картинке ниже выключатель находится в режиме обычного подключения. Для подключения питания от генератора переключите ручку перключателя со стрелкой в сторону нарисованной литеры `G`.
